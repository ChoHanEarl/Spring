...
public class WebMvcConfig implements WebMvcConfigurer{
	...
	//주요 기능
	//CORS(Cross-Origin Resourse Sharing) 설정
	...
	public void addCorsMappings(CorsRegistry registry) {
		...
		registry.addMapping("/**")
		//React 애플리케이션이 실행되는 도메인(출처, Origin)에서 오는 요청을 허용
		...
		//브라우저가 서버로부터 받은 응답을 일정 시간 동안 저장해 두고,
	...
	//특정 HTTP요청이 컨트롤러에 도달하기 전 또는 후에 실행되며, 
	//요청을 가로채어 로깅, 인증, 권한 확인 등의 작업을 수행할 수 있다.
